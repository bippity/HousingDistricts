                ...
                default:
                    {
						...
						ply.SendMessage("Other /house commands: list, allow, disallow, redefine, name, delete, clear, info, chat, addvisitor, delvisitor, addgroup, delgroup,lock, reload", Color.Lime);
                        break;
                    }
            }
        }
